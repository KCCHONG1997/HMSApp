...
//            "Charlie Brown", "ID345678", "charlie_brown", "charlie@example.com", "1122334455",
...
//            "5 ml twice daily"
//        );
//        TreatmentPlans treatmentPlan1 = new TreatmentPlans("D001", LocalDateTime.of(2023, 10, 20, 14, 30), "Wait to die");
//        TreatmentPlans treatmentPlan2 = new TreatmentPlans("D002", LocalDateTime.of(2023, 8, 12, 10, 15), "Cannot Cure");
//
...
//        medsList2.add(med3);
//
//        Prescription prescription1 = new Prescription("D001", LocalDateTime.now(), medsList1);
//        Prescription prescription2 = new Prescription("D002", LocalDateTime.now(), medsList2);
//
//        // Diagnosis Example 1
...
////        PrescribedMedicationRepository.diagnosisToMedicationsMap.put(medsList1.getFirst().getDiagnosisID(), medsList1);
////        PrescribedMedicationRepository.diagnosisToMedicationsMap.put(medsList2.getFirst().getDiagnosisID(), medsList2);
...
////        DiagnosisRepository.addDiagnosis(diagnosis1.getMedicalRecordID(), diagnosis1);
////        DiagnosisRepository.addDiagnosis(diagnosis2.getMedicalRecordID(), diagnosis2);
////        DiagnosisRepository.addDiagnosis(diagnosis3.getMedicalRecordID(), diagnosis3);
...
////        MedicalRecord record1 = new MedicalRecord("P001", "D002");  // Doctor ID D002
////        MedicalRecord record2 = new MedicalRecord("P002", "D003");  // Doctor ID D003
////        MedicalRecord record3 = new MedicalRecord("P003", "D004");  // Doctor ID D004
////
////        // Add some diagnoses to each medical record
////        Diagnosis diagnosis1 = new Diagnosis("P001", "Common Cold", LocalDateTime.now().minusDays(5));
////        Diagnosis diagnosis2 = new Diagnosis("P002", "Seasonal Allergy", LocalDateTime.now().minusDays(10));
////        Diagnosis diagnosis3 = new Diagnosis("P003", "Back Pain", LocalDateTime.now().minusDays(3));
////
...
////        TreatmentPlan treatmentPlan1 = new TreatmentPlan("Common Cold Treatment", LocalDateTime.now().minusDays(4));
////        TreatmentPlan treatmentPlan2 = new TreatmentPlan("Allergy Management", LocalDateTime.now().minusDays(9));
////        TreatmentPlan treatmentPlan3 = new TreatmentPlan("Physiotherapy Sessions", LocalDateTime.now().minusDays(2));
////
...
////
////        Prescription prescription1 = new Prescription(meds1, LocalDateTime.now().minusDays(5));
////        Prescription prescription2 = new Prescription(meds2, LocalDateTime.now().minusDays(10));
////        Prescription prescription3 = new Prescription(meds3, LocalDateTime.now().minusDays(3));
////
...
////                System.out.printf("| %-20s: %-35s |\n", "Date", diagnosis.getDiagnosisDate());
////                System.out.println("+------------------------------------------------------------+");
////            }
////
...
////            System.out.println("+------------------------------------------------------------+");
////            System.out.printf("| %-20s: %-35s |\n", "Description", treatmentPlan.getTreatmentDescription());
////            System.out.printf("| %-20s: %-35s |\n", "Date", treatmentPlan.getTreatmentDate());
////            System.out.println("+------------------------------------------------------------+");
////
...
////                System.out.printf("| %-20s: %-35s |\n", "Medication", med.getMedicationName());
